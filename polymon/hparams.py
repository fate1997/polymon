...
def get_fastkan_hparams(trial: optuna.Trial) -> Dict[str, Any]:
    """Get FastKAN parameters for hyper-parameter tuning.
    """
...
def get_gatport_hparams(trial: optuna.Trial) -> Dict[str, Any]:
    """Get GATPort parameters for hyper-parameter tuning.
    """
...
@register_hparams('gatv2_pe')
def get_gatv2_pe_hparams(trial: optuna.Trial) -> Dict[str, Any]:
    """Get GATv2-PE parameters for hyper-parameter tuning.
    """
...
@register_hparams('dmpnn')
def get_dmpnn_hparams(trial: optuna.Trial) -> Dict[str, Any]:
    """Get DMPNN parameters for hyper-parameter tuning.
    """
