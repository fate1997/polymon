# Adapted from
# https://github.com/pyg-team/pytorch_geometric/blob/master/torch_geometric/nn/conv/gps_conv.py
...
from polymon.model.kan.fast_kan import AttentionWithFastKANTransform
...
class GPSConv(torch.nn.Module):
    ...
    def __init__(
        ...
        elif attn_type == 'fastkan':
            self.attn = AttentionWithFastKANTransform(
                q_dim=channels,
                k_dim=channels,
                v_dim=channels,
    ...
    def forward(
        ...
        **kwargs,
        ...
        elif isinstance(self.attn, AttentionWithFastKANTransform):
            h = self.attn(h, h, h, bias=None, mask=mask)
