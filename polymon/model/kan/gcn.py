...
from polymon.model.utils import KANLinear, ReadoutPhase, MLP
...
class KAN_GCNConv(MessagePassing):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.lin = KANLinear(in_channels, out_channels, add_bias=False, grid_size=grid_size)
